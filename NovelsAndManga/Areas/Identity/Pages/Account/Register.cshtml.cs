...
namespace NovelsAndManga.Areas.Identity.Pages.Account
{
                ...
                if (result.Succeeded)
                {
                    ...
                    if (_userManager.Users.Count() == 1)
                    {
                        ...
                        if (!await _roleManager.RoleExistsAsync(StaticDetails.Role_Admin))
                        {
                            ...
                            var role = new IdentityRole(StaticDetails.Role_Admin);
                        ...
                        {
                            _logger.LogError("Failed to assign Admin role to user.");
